@{
    ...
    FunctionsToExport  = @('Add-JiraGroupMember','Add-JiraIssueAttachment','Add-JiraIssueComment','Add-JiraIssueLink','Add-JiraIssueWatcher','Add-JiraIssueWorklog','Format-Jira','Get-JiraComponent','Get-JiraConfigServer','Get-JiraField','Get-JiraFilter','Get-JiraGroup','Get-JiraGroupMember','Get-JiraIssue','Get-JiraIssueAttachment','Get-JiraIssueComment','Get-JiraIssueCreateMetadata','Get-JiraIssueEditMetadata','Get-JiraIssueLink','Get-JiraIssueLinkType','Get-JiraIssueType','Get-JiraIssueWatcher','Get-JiraPriority','Get-JiraProject','Get-JiraRemoteLink','Get-JiraServerInformation','Get-JiraSession','Get-JiraUser','Get-JiraVersion','Invoke-JiraIssueTransition','New-JiraGroup','New-JiraIssue','New-JiraSession','New-JiraUser','New-JiraVersion','Remove-JiraGroup','Remove-JiraGroupMember','Remove-JiraIssueAttachment','Remove-JiraIssueLink','Remove-JiraIssueWatcher','Remove-JiraRemoteLink','Remove-JiraSession','Remove-JiraUser','Remove-JiraVersion','Set-JiraConfigServer','Set-JiraIssue','Set-JiraIssueLabel','Set-JiraUser','Set-JiraVersion')
